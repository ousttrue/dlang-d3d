...
extern(C) uint LPSAFEARRAY_UserSize(uint* __param__15, uint __param__16, LPSAFEARRAY* __param__17);
extern(C) void HPALETTE_UserFree(uint* __param__18, HPALETTE* __param__19);
extern(C) ubyte* LPSAFEARRAY_UserMarshal(uint* __param__20, ubyte* __param__21, LPSAFEARRAY* __param__22);
extern(C) ubyte* LPSAFEARRAY_UserUnmarshal(uint* __param__23, ubyte* __param__24, LPSAFEARRAY* __param__25);
extern(C) void LPSAFEARRAY_UserFree(uint* __param__26, LPSAFEARRAY* __param__27);
extern(C) ubyte* HPALETTE_UserUnmarshal(uint* __param__28, ubyte* __param__29, HPALETTE* __param__30);
extern(C) uint HPALETTE_UserSize(uint* __param__31, uint __param__32, HPALETTE* __param__33);
extern(C) ubyte* HPALETTE_UserMarshal(uint* __param__34, ubyte* __param__35, HPALETTE* __param__36);
extern(C) ubyte* HICON_UserUnmarshal(uint* __param__37, ubyte* __param__38, HICON* __param__39);
extern(C) void HICON_UserFree(uint* __param__40, HICON* __param__41);
extern(C) ubyte* HICON_UserMarshal(uint* __param__42, ubyte* __param__43, HICON* __param__44);
extern(C) uint WICInProcPointer_UserSize(uint* __param__45, uint __param__46, WICInProcPointer* __param__47);
extern(C) ubyte* WICInProcPointer_UserUnmarshal(uint* __param__48, ubyte* __param__49, WICInProcPointer* __param__50);
...
extern(C) ubyte* WICInProcPointer_UserMarshal(uint* __param__51, ubyte* __param__52, WICInProcPointer* __param__53);
...
extern(C) void WICInProcPointer_UserFree(uint* __param__54, WICInProcPointer* __param__55);
...
extern(C) uint HICON_UserSize(uint* __param__56, uint __param__57, HICON* __param__58);
extern(C) ubyte* HBITMAP_UserUnmarshal(uint* __param__59, ubyte* __param__60, HBITMAP* __param__61);
...
extern(C) void HBITMAP_UserFree(uint* __param__62, HBITMAP* __param__63);
...
extern(C) void BSTR_UserFree(uint* __param__64, BSTR* __param__65);
extern(C) uint HBITMAP_UserSize(uint* __param__66, uint __param__67, HBITMAP* __param__68);
extern(C) ubyte* HBITMAP_UserMarshal(uint* __param__69, ubyte* __param__70, HBITMAP* __param__71);
...
extern(C) ubyte* BSTR_UserUnmarshal(uint* __param__72, ubyte* __param__73, BSTR* __param__74);
extern(C) uint BSTR_UserSize(uint* __param__75, uint __param__76, BSTR* __param__77);
extern(C) ubyte* BSTR_UserMarshal(uint* __param__78, ubyte* __param__79, BSTR* __param__80);
