...
struct Gwlp
{
    ...
    {
        auto pCreateStruct = cast(LPCREATESTRUCT) (lParam);
        SetWindowLongPtr(hWnd, GWLP_USERDATA, cast(LONG_PTR) (pCreateStruct.lpCreateParams));
    }

    static T* Get(T)(HWND hWnd)
    {
        return cast(T* ) (GetWindowLongPtr(hWnd, GWLP_USERDATA));
    }
}
...
extern (Windows) LRESULT WndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_SIZE:
        if (wParam != SIZE_MINIMIZED)
        {
            ...
            renderer.OnSize(hWnd, LOWORD(lParam), HIWORD(lParam));
